...
__all__ = ("CustomSlider", "SliderHandle", "SliderValueLabel")
...
from components.behaviors import BackgroundColorBehavior
from components.behaviors.scale import ScaleBehavior
from components.behaviors.focus import FocusBehavior
...
class CustomSlider(Slider):
    ...
    def add_widget(self, widget, index=0, canvas=None):
        ...
        if isinstance(widget, SliderValueLabel):
        ...
        elif isinstance(widget, SliderHandle):
            widget._slider = self
            self._handle = widget
...
class SliderHandle(BackgroundColorBehavior, FocusBehavior, Widget):
    """
    Handle class.
...
class SliderValueLabel(CustomLabel):
    """
